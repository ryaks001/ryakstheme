						...
						<lol-uikit-dialog-frame class="dialog-frame" orientation="bottom" close-button="false">
							<div class="dialog-content">
								<lol-uikit-content-block class="app-controls-exit-dialog" type="dialog-small" style="width: 500px;">
									<h5 class="Ryaks-Update" style="text-align: center">Thanks for using Ryaks_V3 !!</p>
									<hr class="heading-spacer" />
									<hr class="heading-spacer" />
									<p class="Ryaks-Update" style="text-align: center">If you love RyaksV3, you can support me by sharing this theme to your friend</p>
									<p class="Ryaks-Update" style="text-align: center">or donating me</p>
									<div id="donate"></div>
				...
				window.addEventListener("load", async ()=> {
					...
					window.setInterval(()=>{
						try {
							...
							link1.setAttribute("href", "https://ko-fi.com/Ryaksdacatto")
							link1.setAttribute("target", "_blank")
							link2.setAttribute("href", "https://me.momo.vn/Ryaksdacatto")
